...
class RandomForest extends StatefulWidget {
  @override
  _RandomForestState createState() => _RandomForestState();
}

class _RandomForestState extends State<RandomForest> {
  web() async {
    var url = Uri.http("192.168.43.210", "cgi-bin/task11/random_forest.py",
                  ...
                  children: <Widget>[
                    Center(
                      child: Container(
                        ...
                        width: 270,
                        height: 180,
                        child: Image.asset("assets/random_forest.png"),
                      ),
                    ),
                    Container(
