...
class NaiveBayesClass extends StatefulWidget {
  @override
  _NaiveBayesClassState createState() => _NaiveBayesClassState();
}

class _NaiveBayesClassState extends State<NaiveBayesClass> {
  web() async {
    var url = Uri.http("192.168.43.210", "cgi-bin/task11/naive_bayes.py",
                  ...
                  children: <Widget>[
                    Center(
                      child: Container(
                        ...
                        width: 270,
                        height: 180,
                        child: Image.asset("assets/naive_bayes.jpeg"),
                      ),
                    ),
                    Container(
